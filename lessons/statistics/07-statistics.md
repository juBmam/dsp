...
Frequentist statistics combines probabilities to create an aggregate picture.  
Bayesian statistics uses the individual probabilities to contruct a picture with multiple outcomes and their likelihoods.
